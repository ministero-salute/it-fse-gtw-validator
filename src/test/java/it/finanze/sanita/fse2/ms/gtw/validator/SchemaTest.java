...
class SchemaTest extends AbstractTest {
    ...
    void singletonTest() throws Exception {
        ...
        final String cda = new String(FileUtility.getFileFromInternalResources("Files" + File.separator + "cda_ok"
                + File.separator + "Esempio CDA2_Referto Medicina di Laboratorio v6_OK.xml"), StandardCharsets.UTF_8);
    ...
    void updateSingletonNoExceptionTest() throws Exception {
        insertSchematron();
        SchematronETY schematronETY = mongo.findOne(
                Query.query(Criteria.where("template_id_root").is("2.16.840.1.113883.2.9.10.1.9.1")),
                SchematronETY.class);
