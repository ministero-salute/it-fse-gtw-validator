...
public class VaccSchematronTest extends AbstractTest {
	...
	void cdaOK() throws Exception {
		...
		try (ByteArrayInputStream bytes = new ByteArrayInputStream(schematronWithReplacesUrl.getBytes())) {
			IReadableResource readableResource = new ReadableResourceInputStream("schematron_certificato_VACC v1.2.sch", bytes);
	...
	void cdaOKXslt() throws Exception {
		...
		try (ByteArrayInputStream bytes = new ByteArrayInputStream(schematronWithReplacesUrl.getBytes())) {
			IReadableResource readableResource = new ReadableResourceInputStream("schematron_certificato_VACC v1.2.xslt", bytes);
