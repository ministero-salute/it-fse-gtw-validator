...
<!--________________________________ HEADER _____________________________________________________________-->
	...
	<!-- ClinicalDocument -->
		<rule context="hl7:ClinicalDocument">
			...
			<report test="($code_codeSystemName !='LOINC') or ($code_displayName!= 'Verbale di Pronto Soccorso')"
			...
			>ERRORE-14| L'attributo <name/>/recordTarget/patientRole/patient/administrativeGenderCode/@code='<value-of select="$genderCode"/>' non è valorizzato correttamente. Deve assumere uno dei seguenti valori:'M', 'F', 'UN'</assert-->
			...
			>ERRORE-17| L'elemento <name/>/author/assignedAuthor/assignedPerson DEVE avere l'elemento 'name'</assert-->
			...
			>ERRORE-20| L'elemento <name/>/dataEnterer/assignedEntity/assignedPerson DEVE riportare l'elemento 'name'</assert-->
			...
			>ERRORE-27| L'elemento <name/>/legalAuthenticator/assignedEntity/assignedPerson DEVE contenere l'elemento 'name'</assert-->
		...
		<rule context="//*[@codeSystem='2.16.840.1.113883.1.11.12839']">
			<let name="unit" value="@code"/>
...
<!--________________________________BODY____________________________________________________________________________-->
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody">
			...
			<assert test="count(hl7:component/hl7:section[hl7:code[@code='28574-2']]/hl7:templateId[@root='2.16.840.1.113883.2.9.10.1.6.24'])=1"
			...
			<assert test="count(hl7:component/hl7:section[hl7:code[@code='28574-2']]/hl7:text)=1"
			>ERRORE-58| Sezione Dimissione: la sezione DEVE contenere l'elemento 'text'</assert>
			<!--12.1-->
			<!--Controllo 1° entry/act "Dimissione"-->
				<let name="act_discharge" value="hl7:component/hl7:section[hl7:code[@code='28574-2']]/hl7:entry[hl7:act]/hl7:act"/>
				<assert test="count($act_discharge[@classCode='ACT'][@moodCode='EVN'])=1"
				...
				<assert test="count($act_discharge/hl7:templateId[@root='2.16.840.1.113883.2.9.10.1.6.66'])=1"
				...
				<assert test="count($act_discharge/hl7:code[@code='dimissione'][@codeSystem='2.16.840.1.113883.2.9.5.1.4'])=1"
				...
				<assert test="count($act_discharge/hl7:statusCode[@code='completed'])=1"
				...
				<assert test="count($act_discharge/hl7:effectiveTime)=1"
				>ERRORE-63| Sezione Dimissione: l'entry/act "Dimissione" DEVE contenere un elemento 'effectiveTime'</assert>
				<assert test="count($act_discharge/hl7:performer)=1"
				>ERRORE-64| Sezione Dimissione: l'entry/act "Dimissione" DEVE contenere un elemento 'performer'</assert>
				<!--Performer-->
				<assert test="count($act_discharge/hl7:performer/hl7:assignedEntity/hl7:assignedPerson/hl7:name/hl7:family)=1 and 
				...
				>ERRORE-65| Sezione Dimissione: l'entry/act/performer/assignedEntity/assignedPerson/name DEVE contenere gli elementi 'family' e 'given'</assert>
					...
					<assert test="count($act_discharge/hl7:entryRelationship[hl7:observation/hl7:code[@code='29308-4']])>=1"
					...
					<assert test="count($act_discharge/hl7:entryRelationship[hl7:observation/hl7:code[@code='11302-7']])=1"
					...
					<assert test="count($act_discharge/hl7:entryRelationship/hl7:observation[hl7:code[@code='11302-7']]/hl7:templateId[@root='2.16.840.1.113883.2.9.10.1.6.69'])=1"				
					...
					<assert test="count($act_discharge/hl7:entryRelationship/hl7:observation[hl7:code[@code='11302-7']]/hl7:statusCode[@code='completed'])=1"	
					...
					<assert test="count($act_discharge/hl7:entryRelationship/hl7:observation[hl7:code[@code='11302-7']]/hl7:value[@codeSystem='2.16.840.1.113883.2.9.6.1.54.5'])=1"
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='8716-3']]/hl7:entry">
			...
			<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='29549-3']]/hl7:entry">
				...
				<assert test="($status='completed' and count(hl7:substanceAdministration/hl7:effectiveTime/hl7:high)=1) or
						($status='aborted' and count(hl7:substanceAdministration/hl7:effectiveTime/hl7:high)=1) or 
						($status='suspended' and count(hl7:substanceAdministration/hl7:effectiveTime/hl7:high)=0) or 
						($status='active' and count(hl7:substanceAdministration/hl7:effectiveTime/hl7:high)=0)"
				>ERRORE-242| Sezione Terapia Farmacologica in PS: l'elemento entry/substanceAdministration/effectiveTime/high deve essere presente nel caso in cui lo 'statusCode' sia 'completed'oppure'aborted'</assert>
				-->
